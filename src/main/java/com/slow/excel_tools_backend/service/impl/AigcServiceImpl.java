...
public class AigcServiceImpl implements AigcService {
    ...
    private static final String DEFAULT_API_URL = "https://voapi.killerbest.com";
    private static final String DEFAULT_API_KEY = "sk-McarwsWe1KbApdcT8gkB6KmhsbNNUHvfz6C1LN7VjThovXpX";
    private static final String DEFAULT_MODEL_NAME = "gpt-4.1-mini";

    private static final String OPTIMIZE_PROMPT = "你的角色与目标：\n\n" +
    ...
    @Override
    public Map<String, Object> optimizeArticle(String content, String apiUrl, String apiKey, String modelName) {
        ...
        try {
            ...
            systemMessage.put("content", OPTIMIZE_PROMPT);

            Map<String, String> userMessage = new HashMap<>();
            userMessage.put("role", "user");
            userMessage.put("content", "原文：" + content);

            requestBody.put("messages", new Object[]{systemMessage, userMessage});
            requestBody.put("temperature", 1.74);
            ...
            result.put("text", "内容优化服务暂时不可用，请稍后重试");
            result.put("success", false);
        } catch (Exception e) {
            result.put("text", "无法连接AI服务: " + e.getMessage());
            result.put("success", false);
